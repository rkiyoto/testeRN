...
//       renderItem={ ({item}) =>
//         <Image
//         style={{margin: 3, width: 100, height: 100, alignItems: 'center'}}
  ...
  _renderHeader(section) {
    return (
      <View style={styles.itemCell}>
        <View style={styles.viewTopBar}>
            <View style={styles.itemDate}>
              <Text style={{color: 'rgb(0,157,159)', fontSize: 30, paddingLeft: 5}}>{section.dia}</Text>
            </View>

            <View style={styles.itemDate}>
              <Text style={{color: 'rgb(0,157,159)', fontSize: 12}}>{section.mes}</Text>
              <Text style={{color: 'rgb(0,157,159)', fontSize: 12}}>{section.ano}</Text>
            </View>


            <View style={{flex:1}}>
              <Text style={styles.itemTitle}>{section.key}  Lorem ipsum dolor sit amet, consectetur adipiscing elit.</Text>
            </View>
